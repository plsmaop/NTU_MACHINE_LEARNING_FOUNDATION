...
class Q8(Q7):
    ...
    def __verify(self, round, X, Y, w):
        ...
        self._Q7__freqs[round] = error_rate
        self._Q7__current_error_rate = self.error_rate(self.X, self.Y, w)
        return error_rate
    ...
    def run_and_show_histogram(self, repeated_times, max_update_times):
        f = super(Q8, self).run(repeated_times, max_update_times, self.__update_w, self.__verify)
